...
const parks = [
  {
    ...
    location: "Adibatla, Rangareddy",
    attractions: ["Giant wheel", "Water Slides", "Rain Dance"],
  },
  {
    id: 2,
    name: "Trills Fusion",
    ...
    location: "Nadargul,Rangreddy",
    attractions: ["Quad Biking", "Mud Biking","VR Games"],
  },
  {
    id: 3,
    ...
    location: "Rangareddy",
    attractions: ["Mughal Garden", "Film Shooting Locations", "Butterfly Garden"],
  },
];
              ...
              {parks.map((park) => (
                <Card key={park.id} className="overflow-hidden">
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4">
                      <span className="text-2xl font-bold">INR {park.price}</span>
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="pt-4">
                      <div className="flex justify-between text-sm mb-2">
                        ...
                        <span>INR{selectedPark.price}</span>
                      </div>
                      <div className="flex justify-between font-semibold">
                        <span>Total</span>
                        <span>INR{selectedPark.price * guests}</span>
                      </div>
                    </div>
                  </div>
                  <div className="mt-6">
